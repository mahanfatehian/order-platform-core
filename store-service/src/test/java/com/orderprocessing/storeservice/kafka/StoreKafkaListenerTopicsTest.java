...
class StoreKafkaListenerTopicsTest {

    @Test
    void resolvesStoreListenerDestinationFromConfiguredOrderTopicName() {
        try (AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext()) {
            ...
            assertThat(context.getBean(KafkaListenerEndpointRegistry.class).getListenerContainers())
                    ...
                    .containsExactly(new String[] {"orders.v2"});
        }
    }
    ...
    static class ListenerTestConfiguration {
        @Bean
        StoreKafkaConsumer storeKafkaConsumer() {
            return new StoreKafkaConsumer(mock(InventoryService.class));
        }

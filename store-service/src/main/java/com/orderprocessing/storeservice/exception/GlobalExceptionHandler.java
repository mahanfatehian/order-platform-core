...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleConflict(DataIntegrityViolationException ex, HttpServletRequest request) {
        return build(HttpStatus.CONFLICT, "DATA_CONFLICT", "The requested change conflicts with existing data",
                request, Map.of());
    }
    ...
    public ResponseEntity<ApiError> handleUnexpected(Exception ex, HttpServletRequest request) {
        ...
        log.error("Unexpected store-service failure, correlationId={}", correlationId, ex);
